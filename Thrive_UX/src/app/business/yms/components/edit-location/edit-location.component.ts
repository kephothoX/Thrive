...
export class EditLocationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._squareService.getLocation({id: id}).subscribe((response: any) => {
  ...
  onSubmit() {
    ...
    this._squareService.updateLocation(JSON.stringify(dataSet)).subscribe((response: any) => {
      this._snackBar.open('Location Updated Successfully', 'Close');

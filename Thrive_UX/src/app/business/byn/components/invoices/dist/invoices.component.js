...
var InvoicesComponent = /** @class */ (function () {
    function InvoicesComponent(_formBuilder, _squareService, _currencyService, _authService, _appService, _snackBar) {
    ...
    InvoicesComponent.prototype.onSubmitOrder = function () {
        ...
        this.addNewLineItem();
        this._appService.getSquareMainLocation().subscribe(function (res) {
            var formValues = _this.newOrderForm.value;
            var dataSet = {
                "idempotency_key": self.crypto.randomUUID(),
                "order": {
                    "location_id": formValues.location,
                    "customer_id": localstorage_slim_1["default"].get('customer_id'),
        ...
        this._squareService.generateNewInvoice(dataSet).subscribe(function (result) {
            ...
            setTimeout(function () {
                _this._authService.pangeaAuditLog({
                    message: localstorage_slim_1["default"].get('customer_email_address') + " Just Sent You An Invoice"

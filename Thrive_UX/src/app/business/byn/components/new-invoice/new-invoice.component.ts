...
export class NewInvoiceComponent implements OnInit{
 ...
 ngOnInit() {
   this._squareService.listLocations().subscribe((response: any) => {
     this.locations = response.SQResponse.locations;
  ...
  onSubmitOrder() {
    ...
    this._appService.getSquareMainLocation().subscribe((res: any) => {
      ...
      this._squareService.generateNewOrder(dataSet).subscribe((response: any) => {
  ...
  onSubmitInvoice() {
    ...
    this._squareService.generateNewInvoice(dataSet).subscribe((response: any) => {

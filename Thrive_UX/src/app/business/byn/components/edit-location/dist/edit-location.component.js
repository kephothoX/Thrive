...
var EditLocationComponent = /** @class */ (function () {
    function EditLocationComponent(_formBuilder, _squareService, _authService, _snackBar, _router, _activatedRoute) {
        ...
        this._squareService.updateLocation(dataSet).subscribe(function (result) {
            ...
            setTimeout(function () {
                ...
                _this._authService.pangeaAuditLog({
                    message: localstorage_slim_1["default"].get('customer_email_address') + " Edited Location with ID:  " + ((_a = _this.location) === null || _a === void 0 ? void 0 : _a.id) + "."
    ...
    EditLocationComponent.prototype.resetForm = function () {
        ...
        this._router.navigate(['/business/locations']);
    };
